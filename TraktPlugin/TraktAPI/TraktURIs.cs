...
namespace TraktPlugin.TraktAPI
{
    ...
    public static class TraktURIs
    {
        ...
        public const string SearchUsers = @"http://api.trakt.tv/search/users.json/" + ApiKey + @"/{0}/{1}";
        public const string SearchMovies = @"http://api.trakt.tv/search/movies.json/" + ApiKey + @"/{0}/{1}";
        public const string SearchShows = @"http://api.trakt.tv/search/shows.json/" + ApiKey + @"/{0}/{1}";
        public const string SearchEpisodes = @"http://api.trakt.tv/search/episodes.json/" + ApiKey + @"/{0}/{1}";
        public const string SearchPeople = @"http://api.trakt.tv/search/people.json/" + ApiKey + @"/{0}/{1}";
