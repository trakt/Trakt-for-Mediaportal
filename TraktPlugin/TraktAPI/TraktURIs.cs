...
namespace TraktPlugin.TraktAPI
{
    ...
    public static class TraktURIs
    {
        ...
        public const string UserLibraryEpisodes = @"http://api.trakt.tv/user/library/shows/collection.json/" + ApiKey + @"/{0}";
        public const string UserLibraryMovies = @"http://api.trakt.tv/user/library/movies/all.json/" + ApiKey + @"/{0}";
