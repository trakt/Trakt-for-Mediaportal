...
namespace TraktPlugin.GUI
{
    public class GUICustomListItem : GUIListItem
    {
        ...
        public GUICustomListItem(string strLabel, int windowID) : base(strLabel)
        {
        ...
        public object Item
        {
            ...
            set
            {
                ...
                {
                    if (s is TraktImage && e.PropertyName == "MoviePoster")
                        SetImageToGui((s as TraktImage).MovieImages.Poster.LocalImageFilename(ArtworkType.MoviePoster));
                    if (s is TraktImage && e.PropertyName == "ShowPoster")
                        SetImageToGui((s as TraktImage).ShowImages.Poster.LocalImageFilename(ArtworkType.ShowPoster));
                    // re-size season posters to same as series/movie posters
                    if (s is TraktImage && e.PropertyName == "Season")
                        SetImageToGui((s as TraktImage).ShowImages.Season.LocalImageFilename(ArtworkType.SeasonPoster), new Size(300, 434));
