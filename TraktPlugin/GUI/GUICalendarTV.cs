...
{
    public class GUICalendarTV : GUIWindow
    {
        ...
        public override int GetID
        {
            get
            {
                return (int)TraktGUIWindows.CalendarTV;
            }
        }
        ...
        protected override void OnPageDestroy(int new_windowId)
        {
            ...
            // save current view
            TraktSettings.DefaultTVCalendarView = (int)CurrentCalendar;
            TraktSettings.DefaultTVCalendarStartDate = (int)CurrentStartDate;
        ...
        private void InitProperties()
        {
            ...
            CurrentCalendar = (CalendarType)TraktSettings.DefaultTVCalendarView;
            SetCurrentView();

            CurrentStartDate = (StartDates)TraktSettings.DefaultTVCalendarStartDate;
            SetCurrentStartDate();
