    ...
    public class GUISearchMovies : GUIWindow
    {
        ...
        private void SendSearchResultsToFacade(IEnumerable<TraktMovieSummary> movies)
        {
            ...
            foreach (var movie in movies)
            {
                ...
                var images = new GUITmdbImage { MovieImages = new TmdbMovieImages { Id = movie.Ids.Tmdb } };
        ...
        private void InitProperties()
        {
            ...
            // load last layout
            CurrentLayout = (GUIFacadeControl.Layout)TraktSettings.SearchMoviesDefaultLayout;
