    ...
    public class GUIPopularShows : GUIWindow
    {
        ...
        private void SendPopularShowsToFacade(TraktShowsPopular PopularItems)
        {
            ...
            foreach (var PopularItem in filteredPopularList)
            {
                ...
                var image = new GUITraktImage { ShowImages = PopularItem.Images };
        ...
        private void InitProperties()
        {
            ...
            // load last layout
            CurrentLayout = (Layout)TraktSettings.PopularShowsDefaultLayout;
        ...
        private void OnShowSelected(GUIListItem item, GUIControl parent)
        {
            ...
            GUIImageHandler.LoadFanart(backdrop, PopularItem.Images.Fanart.LocalImageFilename(ArtworkType.ShowFanart));
        }
