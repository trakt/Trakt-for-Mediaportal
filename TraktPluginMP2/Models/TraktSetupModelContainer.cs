...
{
  internal static class TraktSetupModelContainer
  {
    ...
    internal static TraktSetupModelManager ResolveManager()
    {
      ...
      return new TraktSetupModelManager(mediaPortalServices, traktClient, traktCache, fileOperations);
    }
  }
}